local construct_immediate_graph_root = import './construct_immediate_graph_root.libsonnet';

{
  output(input):: construct_immediate_graph_root(input),
  tests: [
    {
    ...
    },
    {
      ...
      output(input)::
        local pods = construct_immediate_graph_root(input).namespaces.name('default').pods;
        {
          node: pods,
    ...
    },
    {
      ...
      output(input):: construct_immediate_graph_root(input).demo._view,
      expected: 'custom',
    },
    {
      ...
      output(input)::
        local parents = construct_immediate_graph_root(input).parents;
        {
          a: parents.a('x'),
          b: parents.b('y'),
        },
